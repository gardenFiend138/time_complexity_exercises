...
1. _F_ind the time complexity of one call, ignoring the recursive calls.
2. _F_ind the number of times the function is called, and, if necessary, the input sizes on all of those calls.
3. _S_um everything together.
